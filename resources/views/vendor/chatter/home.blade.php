...
@section(Config::get('chatter.yields.head'))
	...
	@if($chatter_editor == 'simplemde')
		<link href="{{asset('/vendor/devdojo/chatter/assets/css/simplemde.min.css')}}" rel="stylesheet">
	@endif
@stop

@section('content_header')
    <div style="left:0; padding: 0px; right: 0; margin:auto; height: 55px; width: 90%; margin-left:15px; position: absolute; z-index:99;  bottom:{{!isset($hm)?'-60px;':'-60px;'}}">
            ...
            <div class="col-md-12" style="min-height: 40px;">
              <div style="width:100%; float: left; border-radius: 30px; overflow: hidden; border: 1px solid #fa090a ">
                <div class="input-group" style="height:20px;">
                  <input type="text" class="form-control input-sm" name="q" placeholder=".." style="border: none; height:50px;" value="{{isset($req)?$req->q:(isset($_GET['q'])?$_GET['q']:'')}}">
...
<div id="chatter" class="chatter_home">
	...
	@endif
	@if($category)
		<h4 class="text-center"><b>{{$category->name}}</b></h4>
	@endif
	...
	<div id="new_discussion">
    	...
    	<form id="chatter_form_editor" action="{{ url(Config::get('chatter.routes.home') .'/'. Config::get('chatter.routes.discussion')) }}" method="POST">
            ...
            <div id="new_discussion_footer">
            	<input  class="form-control" type='text' id="color" name="color" /><span class="select_color_text">Select a Color for this Discussion (optional)</span>
