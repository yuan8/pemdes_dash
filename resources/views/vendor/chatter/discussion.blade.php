	            ...
	            @if(!Auth::guest())
	            	...
	            	<div id="new_response">
			            ...
			            <div id="new_discussion">
				            ...
				            <form id="chatter_form_editor" action="{{ asset(Config::get('chatter.routes.home').'/posts')}}" method="POST">
...
<script src="{{asset('/vendor/devdojo/chatter/assets/js/simplemde.min.js')}}"></script>
<script src="{{asset('/vendor/devdojo/chatter/assets/js/chatter_simplemde.js')}}"></script>
